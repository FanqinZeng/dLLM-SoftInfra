...
COMMANDS = [
    ...
    ## gsm8k
    # eb_sampler
    "DREAM_INST_PATH=/remote-home/fanqinzeng/DLLM/model/dParallel-Dream-7B-instruct accelerate launch --num_machines 1 --num_processes 1 eval.py dataset.name=gsm8k batch_size=1 seed=1234 generation=eb_sampler generation.gen_length=256 generation.block_length=32 generation.gamma=0.00001 model=dream-inst hydra.run.dir=./outputs_dream/gsm8k/eb_sampler_000001",
    # "DREAM_INST_PATH=/remote-home/fanqinzeng/DLLM/model/dParallel-Dream-7B-instruct accelerate launch --num_machines 1 --num_processes 1 eval.py dataset.name=gsm8k batch_size=1 seed=1234 generation=eb_sampler generation.gen_length=256 generation.block_length=32 generation.gamma=0.0001 model=dream-inst hydra.run.dir=./outputs_dream/gsm8k/eb_sampler_00001",
    # confidence
    "DREAM_INST_PATH=/remote-home/fanqinzeng/DLLM/model/dParallel-Dream-7B-instruct accelerate launch --num_machines 1 --num_processes 1 eval.py dataset.name=gsm8k batch_size=1 seed=1234 generation=vanilla generation.steps=512 generation.gen_length=256 generation.block_length=32 generation.threshold=0.95 model=dream-inst hydra.run.dir=./outputs_dream/gsm8k/vanilla_th0.95",
    # "DREAM_INST_PATH=/remote-home/fanqinzeng/DLLM/model/dParallel-Dream-7B-instruct accelerate launch --num_machines 1 --num_processes 1 eval.py dataset.name=gsm8k batch_size=1 seed=1234 generation=vanilla generation.steps=512 generation.gen_length=256 generation.block_length=32 generation.threshold=0.8 model=dream-inst hydra.run.dir=./outputs_dream/gsm8k/vanilla_th0.85",
   
    ## humaneval_instruct
    # # eb_sampler
    "DREAM_INST_PATH=/remote-home/fanqinzeng/DLLM/model/dParallel-Dream-7B-instruct accelerate launch --num_machines 1 --num_processes 1 eval.py dataset.name=humaneval_instruct batch_size=1 seed=1234 generation=eb_sampler generation.gen_length=512 generation.block_length=32 generation.gamma=0.00001 model=dream-inst hydra.run.dir=./outputs_dream/humaneval/eb_sampler_000001",
    # "DREAM_INST_PATH=/remote-home/fanqinzeng/DLLM/model/dParallel-Dream-7B-instruct accelerate launch --num_machines 1 --num_processes 1 eval.py dataset.name=humaneval_instruct batch_size=1 seed=1234 generation=eb_sampler generation.gen_length=512 generation.block_length=32 generation.gamma=0.0001 model=dream-inst hydra.run.dir=./outputs_dream/humaneval/eb_sampler_00001",
    # confidence
    "DREAM_INST_PATH=/remote-home/fanqinzeng/DLLM/model/dParallel-Dream-7B-instruct accelerate launch --num_machines 1 --num_processes 1 eval.py dataset.name=humaneval_instruct batch_size=1 seed=1234 generation=vanilla generation.steps=512 generation.gen_length=512 generation.block_length=32 generation.threshold=0.95 model=dream-inst hydra.run.dir=./outputs_dream/humaneval/vanilla_th0.95",
